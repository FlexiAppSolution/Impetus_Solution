...
using PANE.Framework.Managed.AuditTrail.Exceptions;

namespace PANE.Framework.Managed.AuditTrail
{
    public class AuditTrailInterceptorOld : IInterceptor
    {
        private ISession _session;
        private List<AuditTrail.DTO.AuditTrail> _inserts = new List<PANE.Framework.Managed.AuditTrail.DTO.AuditTrail>();
        private List<AuditTrail.DTO.AuditTrail> _updates = new List<PANE.Framework.Managed.AuditTrail.DTO.AuditTrail>();
        private List<AuditTrail.DTO.AuditTrail> _deletes = new List<PANE.Framework.Managed.AuditTrail.DTO.AuditTrail>();
        ...
        public void OnDelete(object entity, object id, object[] state, string[] propertyNames, NHibernate.Type.IType[] types)
        {
            ...
            {
                AuditTrail.DTO.AuditTrail trail = new PANE.Framework.Managed.AuditTrail.DTO.AuditTrail();
                trail.Action = PANE.Framework.Managed.AuditTrail.Enums.AuditAction.DELETE; //Action currently performed.
        ...
        public bool OnFlushDirty(object entity, object id, object[] currentState, object[] previousState, string[] propertyNames, NHibernate.Type.IType[] types)
        {
            ...
            {
                AuditTrail.DTO.AuditTrail trail = new PANE.Framework.Managed.AuditTrail.DTO.AuditTrail();
                trail.Action = PANE.Framework.Managed.AuditTrail.Enums.AuditAction.UPDATE; //Action currently performed.
                trail.ActionDate = DateTime.Now;                                   //Current date.
                ...
                byte[] newObjectBytes = PANE.Framework.Managed.Utility.BinarySerializer.SerializeObject(entity);
                object newObject = PANE.Framework.Managed.Utility.BinarySerializer.DeSerializeObject(newObjectBytes);
        ...
        public bool OnSave(object entity, object id, object[] state, string[] propertyNames, NHibernate.Type.IType[] types)
        {
            ...
            {
                AuditTrail.DTO.AuditTrail trail = new PANE.Framework.Managed.AuditTrail.DTO.AuditTrail();
                trail.Action = PANE.Framework.Managed.AuditTrail.Enums.AuditAction.CREATE; //Action currently performed.
                trail.ActionDate = DateTime.Now;                                   //Current date.
