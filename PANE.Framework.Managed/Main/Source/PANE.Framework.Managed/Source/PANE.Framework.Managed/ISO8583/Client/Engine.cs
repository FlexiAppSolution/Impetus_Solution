...
using PANE.Framework.Managed.ISO8583.Client.DTO;
using PANE.Framework.Managed.ISO8583.Client.Messages;
...
using PANE.Framework.Managed.ISO8583.Client.Exceptions;
using PANE.Framework.Managed.ISO8583.DTO;
using PANE.Framework.Managed.ISO8583.DAO;


namespace PANE.Framework.Managed.ISO8583.Client
{
    public class Engine
    {
        ...
        private Trx.Messaging.Message ProcessRequest(Iso8583Message msg)
        {
            ...
            msgLog.Message = PANE.Framework.Managed.Utility.BinarySerializer.SerializeObject(msg.Fields);
            ...
            else
            {
                ...
                msgLog.ResponseMessage = PANE.Framework.Managed.Utility.BinarySerializer.SerializeObject(clo.Fields);
