<%@ Page Title="" Language="C#" MasterPageFile="~/RegularSite.master" AutoEventWireup="true" CodeFile="GetLicense.aspx.cs" Inherits="GetLicense" %>
		...
		<ul class="media-list">
		  <li class="media well well-small">
				...
				<div class="media-body">
				  <h4 class="media-heading">Get License</h4>
                  <fieldset> 
        ...
        <td colspan="3">
           ...
           <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtToken" runat="server" Width="336px"></asp:TextBox>
                 ...
                 <td><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                        ErrorMessage="Required" Font-Italic="True" Font-Names="Calibri" 
                            ControlToValidate="txtToken" ForeColor="Red" InitialValue="0">Required</asp:RequiredFieldValidator></td>
            </tr>  
            <tr>
                <td class="style1"> License Type</td>
                
                <td>
                    <asp:DropDownList ID="DropDownLicensetype" runat="server"   Width="336px"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtLicense" runat="server" Width="336px"></asp:TextBox>
            ...
            <tr>
                <td class="style1"></td>
                <td colspan="2">
                    <asp:Button ID="btnCreate" runat="server" Text="Get License"   
