			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav pull-right">
						...
						<li class="active"><a href="OurServices.aspx">Our Services</a></li>						
	...
	<div class="row">
		<div class="span3">
			<div class="well well-small">
				<h3>Card<span style="color:#39b9d6"> Technologies</span></h3>
	            <figure class="p2"><img style="border-color:Blue; border-width:thin; border-style:solid;" src="themes/images/banner/company2.jpg" alt="" /></figure><br /><br />
			</div>												
		...
		<ul class="media-list">
		  <li class="media well well-small">
				...
				<div class="media-body">
				  <h4 class="media-heading">Our Product & Services</h4>
                  <ul>
                  <li>Sales & Support for Access Control and Identification</li>
                  <li>EMV solutions providing Centralized and Decentralized card issuance schemes</li>
                  <li>Custom hardware and software development for special needs s 2D ID card production using Biometrics s Automatic finger identification systems (AFIS)</li>
                  </ul>					
					<br/>
				</div>
		  </li>		  
