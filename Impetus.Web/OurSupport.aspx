<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OurSupport.aspx.cs" Inherits="OurSupport" %>
	...
	<div class="row">
		<div class="span3">
			<div class="well well-small">
                ...
                Are you a new user?<a href="Register.aspx" id="AReg" runat="server"> Click here</a> to register.
			</div>												
		...
		<ul class="media-list">
		  <li class="media well well-small">
				...
				<div class="media-body">
				  <h4 class="media-heading">Login to Access our Support Portal</h4>
                  <fieldset style="border-color:Red; border-style:outset; border-width:thin;">                  
                  <table cellpadding="5px" cellspacing="10px">
                  <tr>
                  <td colspan="2"><asp:Label ID="lblmessage" ForeColor="Red" Font-Names="Calibri" runat="server" Font-Italic="true"></asp:Label></td>
                  </tr>
                  <tr>
                      <td><asp:Label ID="lblInstitutionCode" runat="server" Text="Institution Code:" Font-Bold="true"></asp:Label></td>
                      <td><asp:TextBox ID="txtInstitutionCode" runat="server" Width="350px"></asp:TextBox></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td><asp:Label ID="Label2" runat="server" Text="Password:" Font-Bold="true"></asp:Label></td>
                      <td><asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="350px"></asp:TextBox></td>
                  </tr>
                  <tr>
                  <td>
                  &nbsp;
