<%@ Page Title="" Language="C#" MasterPageFile="~/RegularSite.master" AutoEventWireup="true" CodeFile="LogCase.aspx.cs" Inherits="LogCase" %>
		...
		<ul class="media-list">
		  <li class="media well well-small">
				...
				<div class="media-body">
				  <h4 class="media-heading">Log Case</h4>
                  <fieldset> 
       ...
       <table cellpadding="10px" cellspacing="10px">        
        ...
        <td colspan="3">
            ...
            <tr>
                <td class="style1"></td>
                <td colspan="2">
                    <asp:Button ID="btnCreate" runat="server" Text="Log Case"   
                    BackColor="Maroon" BorderColor="Maroon" ForeColor="White"                     
                        BorderWidth="2px" Font-Bold="True" Font-Names="Calibri" Font-Size="Small" onclick="btnLog_Click" />
                </td>
            </tr>       
             <tr>     
