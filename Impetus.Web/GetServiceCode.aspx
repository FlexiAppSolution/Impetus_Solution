<%@ Page Title="" Language="C#" MasterPageFile="~/RegularSite.master" AutoEventWireup="true" CodeFile="GetServiceCode.aspx.cs" Inherits="GetServiceCode" %>
	...
	<div class="row">
		...
		<ul class="media-list">
		  <li class="media well well-small">
				...
				<div class="media-body">
				  <h4 class="media-heading">Get Service Code</h4>
                  <fieldset> 
       ...
       <table cellpadding="10px" cellspacing="10px">        
        ...
        <td colspan="3">
          ...
          <tr>
                <td class="style1">Wrong Service Code</td>
                <td>
                    
                    <asp:TextBox ID="txtWrongCode" runat="server" Width="336px"></asp:TextBox>
                 ...
                 <td><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                        ErrorMessage="Required" Font-Italic="True" Font-Names="Calibri" 
                            ControlToValidate="txtWrongCode" ForeColor="Red" InitialValue="0">Required</asp:RequiredFieldValidator></td>
            </tr>  
            <tr>
                <td class="style1">Right Service Code</td>
                <td>
            ...
            <tr>
                <td class="style1"></td>
                <td colspan="2">
                    <asp:Button ID="btnCreate" runat="server" Text="Get Service Code"   
