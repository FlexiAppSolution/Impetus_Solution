<%@ Page Title="" Language="C#" MasterPageFile="~/RegularSite.master" AutoEventWireup="true" CodeFile="LicenseRequestList.aspx.cs" Inherits="LicenseRequestList" %>
	...
	<div class="row">
		<div class="span3">
			<div class="well well-small">
                ...
                <p><a id="A2"  href="LicenseRequestList.aspx" runat="server" title="View License Request List">View License Request List</a></p></div>												
		</div>
		<div class="span9">
        ...
        <hr style="border-color:Black; border-style:inset; border-width:thin;"/>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" onpageindexchanging="GridView1_PageIndexChanging" 
                        ...
                        <asp:TemplateField HeaderText="Requesting User"  HeaderStyle-BackColor="Maroon" HeaderStyle-BorderStyle="Outset" HeaderStyle-ForeColor="White" HeaderStyle-BorderColor="Black"  >
                           <ItemTemplate>
                                <asp:Label ID="lblUser" runat="server" Text='<%# Eval("RequestingUser.FullName") %>'></asp:Label> 
                            </ItemTemplate>                       
