...
namespace PANE.Framework.ISO8583.DAO
{
    public class IsoMessageDAO : CoreDAO<IsoMessage, long>
    {
        public static IsoMessage RetrieveBySTAN(long stan, MessageEntity source)
        {
        ...
        public static IsoMessage RetrieveBySTAN(string originalDataElements, MessageEntity source)
        {
            IsoMessage result = null;
            ISession session = BuildSession();
            try
        ...
        public static IList<IsoMessage> Search(DateTime dateFrom, DateTime dateTo, string messageType, string stan, int sender, int receiver)
        {
        ...
        public static IList<IsoMessage> Search(DateTime dateFrom, DateTime dateTo, string messageType, string stan, int sender, int receiver, string cardPAN, int maximumRows, int startRowIndex)
        {
            IList<IsoMessage> result = new List<IsoMessage>();
            ISession session = BuildSession();
            try
